...
const Testimonial = () => {
	...
	const testimonials = clientInfo?.testimonials || [];

	if (loading) {
		return (
			<div className="h-screen flex justify-center items-center bg-gradient-to-r from-blue-100 to-indigo-200">
				<p className="text-xl font-semibold text-indigo-700 animate-pulse">Loading testimonials...</p>
			</div>
		);
	}
	...
	if (testimonials.length === 0) {
		return (
			<div className="h-screen flex justify-center items-center bg-gradient-to-r from-blue-100 to-indigo-200 p-8">
				<div className="bg-white p-8 rounded-xl shadow-lg text-center max-w-md">
					<h3 className="text-2xl font-bold text-indigo-700 mb-4">No Testimonials Yet</h3>
					<p className="text-gray-600 mb-6">
						You haven't submitted any testimonials yet. Let us know how we did by sharing your experience!
					</p>
				</div>
			</div>
		);
								...
								<motion.div
									...
									<div className="flex items-center mt-4">
										<Image
											...
											width={48}
											height={48}
											className="rounded-full mr-4 shadow-md object-cover"
										/>
										<div>
