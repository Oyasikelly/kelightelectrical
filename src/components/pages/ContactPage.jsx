	...
	switch (action.type) {
		case "SET_FIELD":
			return {
				...
				errors: { ...state.errors, [action.field]: "" }, // clear error for field
			};
		case "SET_ERRORS":
...
const ContactPage = () => {
	...
	const { formData, errors, submitted, errorMsg } = state;
	...
	async function submitContact() {
		try {
			...
			dispatch({ type: "SET_ERROR_MSG", errorMsg: "An error occurred!" });
		}
	}

	return (
		<div className="container mx-auto p-6 lg:p-12 space-y-16 max-w-7xl">
			{/* Hero Section */}
			<motion.div
